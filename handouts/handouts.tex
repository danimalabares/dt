...
%In conclusion, for each \(\alpha\) there are finitely many \(W_\beta\) determined by the \(V_i\), and there are finitely many \(U_\alpha\) which intersect at a given point.
...
\section{Vector fields and derivations}
...
\begin{thing3}{Definition 3.2}\label{def:3.2}\leavevmode
...
\begin{thing4}{Exercise extra}\label{exer:extra}\leavevmode
